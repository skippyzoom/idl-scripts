...
path = get_base_dir()+path_sep()+'parametric_wave/run017/'
...
;; @den1_kttrms_frames
;; @get_efield_plane
;; save, Ex,Ey,filename=expand_path(path+path_sep()+'efield_arrays.sav')

;; ;;-->Temporary
;; restore, filename=path+'efield_arrays.sav',/verbose
