;+
; Script for making frames from a plane of EPPIC fluxy1fft_t data
; (i.e., fluxy1 data after spectral transform in space only). See 
; calc_fluxy1fft_t.pro 
;
