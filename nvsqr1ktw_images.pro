;+
; Script for creating images of nvsqr1(k,theta,w).
;
...
for il=0,nl-1 do $
   frm[il] = $
   ktw_image_frame(reverse(nvsqr1ktw[lambda[il]].f_interp,1), $
                   nvsqr1ktw[lambda[il]].t_interp/!dtor, $
                   wdata, $
                   /power, $
                   /log, $
                   /normalize, $
