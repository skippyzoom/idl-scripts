;+
; Script for making frames from a plane of EPPIC fluxx1fft_t data
; (i.e., fluxx1 data after spectral transform in space only). See 
; calc_fluxx1fft_t.pro 
;
