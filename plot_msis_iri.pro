...
;;==Declare data directory (read)
data_dir = '~'+path_sep()+'MSIS_IRI_plots'+path_sep()
data_dir = expand_path(data_dir)

;;==Declare plot directory (write)
plot_dir = data_dir+path_sep()+'frames'
...
;;==Declare the latitude (see files in ~/Data)
lat = 80
strlat = 'lat'+strcompress(string(lat,format='(i02)'),/remove_all)

;;==Assign IRI parameters
data['iri'].file_name = 'iri2016-'+strlat+'-0060-1000-02.lst'
...
data['msis'].file_name = 'nrlmsise-'+strlat+'-0000_1000_02.lst'
