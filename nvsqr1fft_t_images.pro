;+
; Script for making frames from a plane of EPPIC nvsqr1fft_t data
; (i.e., nvsqr1 data after spectral transform in space only). See
; calc_nvsqr1fft_t.pro 
;
