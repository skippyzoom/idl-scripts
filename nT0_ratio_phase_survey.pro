;+
; Script for making survey images from calc_nT0_ratio_phase
;
...
filename = build_filename('den0_temp0_ratio_phase',frame_type, $
                          path = filepath, $
                          additions = axes)
...
frm = objarr(n_frm)
for it=0,n_frm-1 do $
   frm[it] = image(ratio_arg[x0:xf-1,y0:yf-1,ind_mask[it]]/!dtor, $
